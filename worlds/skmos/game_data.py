...
spiritData = [
    ...
    SpiritData(13, Names.Bason,            60,      ItemClassification.useful,          boss = Names.Len_Tao_Boss),
    ...
    SpiritData(26, Names.Black_Raven,      None,    ItemClassification.useful,          lvl.TG7),
...
spiritCombo = {
    ...
    SpiritCombo(4, Names.Cavalry_Charge, 55, ItemClassification.useful, [Names.Bason, Names.Black_Raven]),
    ...
    SpiritCombo(7, Names.Jaguar_Man, 10, ItemClassification.useful, [Names.Mic, Names.Pascal_Avaf]),
