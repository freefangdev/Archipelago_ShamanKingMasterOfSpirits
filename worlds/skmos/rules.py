...
def set_all_rules(world: ShamanKingMasterOfSpiritsWorld) -> None:
...
#def set_all_entrance_rules(world: ShamanKingMasterOfSpiritsWorld) -> None:
    ...
    #overworld_to_final_boss_room = world.get_entrance("Worldmap to Final Boss Room")
    ...
    #set_rule(overworld_to_final_boss_room, lambda state: state.has("Mic", world.player))
...
#def set_all_location_rules(world: ShamanKingMasterOfSpiritsWorld) -> None:
...
def set_completion_condition(world: ShamanKingMasterOfSpiritsWorld) -> None:
    ...
    world.multiworld.completion_condition[world.player] = lambda state: state.has("Mic", world.player)
